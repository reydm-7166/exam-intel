  ...
  <Head title="Transforming API"/>
    <div id="container" class="bg-[#3AAFA9] pt-[30px] h-fit min-h-screen">
      ...
      <div id="result" class="h-fit min-h-[500px] mx-auto rounded-[10px] mt-[50px] w-[80%] h-[500px] flex justify-center items-start p-2 break-all">
          ...
          <div id="original-api"
               class="bg-[#afcccb] p-2 w-[50%] mx-1 h-full rounded-[5px] h-[100%] min-h-[500px]">
          ...
          <div id="processed-api" class="bg-[#afcccb] p-2 w-[50%] mx-1 h-full rounded-[5px] h-[100%] min-h-[500px]">
